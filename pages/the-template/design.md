# the-template — Design Spec (Immersive Dark Edition)
...
## Palette history
- 2026-04-18 — Chapter05 repainted to light palette, Ch.5 purple zone via --accent-ch5 + --accent-ch5-gradient finale (Phase 2C5).
