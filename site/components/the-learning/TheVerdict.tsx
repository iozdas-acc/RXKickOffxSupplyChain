    ...
    <section className="py-24 bg-[#FAFAFA]">
      <div className="max-w-3xl mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <span className="text-xs font-medium text-[#3DB19A] uppercase tracking-widest">The Finding</span>
          <div className="w-10 h-px bg-[#3DB19A]" />
        </motion.div>
        ...
        <motion.h2
          ...
          className="font-display text-3xl md:text-4xl font-bold italic text-[#1C1C2E] text-center"
        >
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-[#1C1C2E] font-medium leading-relaxed">
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.02, boxShadow: '0 8px 32px rgba(61, 177, 154,0.12)', transition: { duration: 0.2 } }}
            className="bg-[#3DB19A]/5 border-2 border-[#3DB19A]/30 rounded-xl p-6 cursor-default"
          >
            <p className="text-xs text-[#3DB19A] uppercase tracking-widest mb-3">What needed to change</p>
            <p className="text-[#1C1C2E] font-medium leading-relaxed">
