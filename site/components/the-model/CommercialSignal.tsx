      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <p className="text-[#3DB19A] text-xs font-medium uppercase tracking-widest mt-2">{stat.label}</p>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-xs font-medium text-[#3DB19A] uppercase tracking-widest">The Principle</span>
            <div className="w-10 h-px bg-[#3DB19A]" />
          </motion.div>
          ...
          <motion.h2
            ...
            className="font-display text-3xl md:text-4xl font-bold italic text-[#1C1C2E]"
          >
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-[#1C1C2E] font-medium leading-relaxed text-sm">
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.02, boxShadow: '0 8px 32px rgba(28, 28, 46,0.12)', transition: { duration: 0.2 } }}
              className="bg-[#0F1D3C]/5 border-2 border-[#0F1D3C]/25 rounded-xl p-6 cursor-default text-left"
            >
              <p className="text-xs text-[#0F1D3C] uppercase tracking-widest mb-3">Hybrid model</p>
              <p className="text-[#1C1C2E] font-medium leading-relaxed text-sm">
